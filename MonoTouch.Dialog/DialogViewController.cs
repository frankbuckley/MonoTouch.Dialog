...
public class DialogViewController : UITableViewController
{
...
#endif
        originalSections = [.. Root.Sections];
    ...
    public virtual void FinishSearch()
    {
        ...
        Root.Sections = [.. originalSections];
    ...
    public void PerformFilter(string text)
    {
        ...
        for (int sidx = 0; sidx < originalSections.Length; sidx++)
        {
            ...
            var elements = originalElements[sidx];
    ...
    public class Source : UITableViewSource
    {
        ...
        private readonly WeakReference<DialogViewController> container;
        ...
        public override void WillDisplay(UITableView tableView, UITableViewCell cell, NSIndexPath indexPath)
        {
            if (Root.NeedColorUpdate)
            {
                var section = Root.Sections[indexPath.Section];
                var element = section.Elements[indexPath.Row];
                if (element is IColorizeBackground colorized)
                {
        ...
        {
            Container.OnSelection?.Invoke(indexPath);
        ...
        {
            var section = Root.Sections[(int)sectionIdx];
            return section.HeaderView == null ? (nfloat)(-1) : section.HeaderView.Frame.Height;
        }
        ...
        {
            var section = Root.Sections[(int)sectionIdx];
            return section.FooterView == null ? (nfloat)(-1) : section.FooterView.Frame.Height;
        }
    ...
    public class SizingSource : Source
    {
        ...
        public override nfloat GetHeightForRow(UITableView tableView, NSIndexPath indexPath)
        {
            ...
            return element is not IElementSizing sizable ? tableView.RowHeight : sizable.GetHeight(tableView, indexPath);
        }
    }
    ...
    public void ActivateController(UIViewController controller)
    {
        ...
        if (parent is UINavigationController nav && controller is not UINavigationController)
        {
    ...
    {
        add => ViewDisappearing += value; remove => ViewDisappearing -= value;
    }
